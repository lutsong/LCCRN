...
def default_train(train_loader, model, optimizer, writer, iter_counter):
    ...
    writer.add_scalar('W_1',model.W[0].item(),iter_counter)
    writer.add_scalar('W_2',model.W[1].item(),iter_counter)
    writer.add_scalar('W_3',model.W[2].item(),iter_counter)
    writer.add_scalar('W_4',model.W[3].item(),iter_counter)
    writer.add_scalar('amplitude',model.amplitude.item(),iter_counter)
    writer.add_scalar('alpha_1', model.r[0].item(), iter_counter)
    writer.add_scalar('alpha_2', model.r[1].item(), iter_counter)
    writer.add_scalar('alpha_3', model.r[2].item(), iter_counter)
    writer.add_scalar('alpha_4', model.r[3].item(), iter_counter)
    writer.add_scalar('beta_1', model.r[4].item(), iter_counter)
    writer.add_scalar('beta_2', model.r[5].item(), iter_counter)
    writer.add_scalar('beta_3', model.r[6].item(), iter_counter)
    writer.add_scalar('beta_4', model.r[7].item(), iter_counter)
    avg_frn_loss = 0
    avg_aux_loss = 0
    avg_loss = 0
    avg_acc = 0
