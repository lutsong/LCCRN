...
sys.path.append('../../../../')
from trainers import trainer,LCCRN_train
from datasets import dataloaders
from models.LCCRN import LCCRN
...
model =LCCRN(way=train_way,
            shots=[args.train_shot, args.train_query_shot],
            resnet=args.resnet)

train_func = partial(LCCRN_train.default_train,train_loader=train_loader)
